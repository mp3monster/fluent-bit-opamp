...
<#
.SYNOPSIS
Compatibility wrapper for Codex-first parameter naming.

.DESCRIPTION
Preserves legacy semantics where -ServerName maps to the ChatGPT/Codex MCP server
name, then delegates execution to configure-mcp-clients-fastmcp.ps1.
